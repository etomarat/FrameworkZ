...
ProjectFramework.Overrides = {}
ProjectFramework.Overrides.ISToolTipInv_render = ISToolTipInv.render

function ProjectFramework.Overrides.WordWrapText(text)
...
function ProjectFramework.Overrides.DoTooltip(objTooltip, item, panel)
    ...
    if itemData then
        ...
        local description = ProjectFramework.Overrides.WordWrapText(itemDescription)
...
ISToolTipInv.render = function(self)
    ...
    if self.item ~= nil and self.tooltip ~= nil then
        ProjectFramework.Overrides.DoTooltip(self.tooltip, self.item, self);
    else

...
function PFW_LoadCharacterMenu:initialise()
    ...
    self.leftCharacter = PFW_CharacterView:new(xLeft, yLeft, widthLeft, heightLeft, isoPlayer, self.characters[1], "", "")
    self.leftCharacter:setVisible(false)
    self.leftCharacter:initialise()
    self:addChild(self.leftCharacter)

    self.selectedCharacter = PFW_CharacterView:new(xSelected, ySelected, widthSelected, heightSelected, isoPlayer, self.characters[1], "", "")
    self.selectedCharacter:setVisible(false)
    self.selectedCharacter:initialise()
    self:addChild(self.selectedCharacter)

    self.rightCharacter = PFW_CharacterView:new(xRight, yRight, widthRight, heightRight, isoPlayer, self.characters[1], "", "")
